...
do
	...
	function section:updateDropdown(dropdown, title, list, callback)
		...
		S9s08:addButton("Copy Link Discord",function()
			...
			setclipboard("https://discord.gg/2eatfacbGA")
		end)

		S9s08:addButton("Credit",function()

			L9s0:Notify("CREDIT ", "Sightless Hub")
			wait(2.5)
			L9s0:Notify("CREDIT ", "Free Script Sightless Hub")
		end)
	...
	if placeId == 4442272183 then --- Blox Fruit New World
		...
		if game.CoreGui:FindFirstChild("Sightless Hub - Blox Fruit (New World)") then
			game.CoreGui:FindFirstChild("Sightless Hub - Blox Fruit (New World)"):Destroy()
		end

		local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ohmtime1/GUI-Blox-fruits/c8af5dcd7771dd608bc988ca13c0e196b88dafb1/README.md"))()

		local L9s0 = library.new("Sightless Hub - Blox Fruit (New World)")
		...
		S9s05:addButton("Low Graphic",function()
	...
	if placeId == 189707 then --- Natural Disaster Survival
		...
		local library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ohmtime1/SL-less/main/README.md"))()

		local L9s0 = library.new("Sightless Hub - Natural Disaster Survival")
		...
		S9s03:addButton("Low Graphic",function()
		...
		S9s04:addButton("Copy Link Discord",function()
			...
			setclipboard("https://discord.gg/eAcYBM8HdA")
		end)
